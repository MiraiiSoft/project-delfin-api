...
CREATE TABLE `counter` (
    ...
    `id_counter` VARCHAR(255) NULL,
    `seq_value` INTEGER NULL,

    UNIQUE INDEX `id_counter`(`id_counter`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `detalle_venta` ADD CONSTRAINT `detalle_venta_ibfk_2` FOREIGN KEY (`id_producto`) REFERENCES `producto`(`id_producto`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `detalle_venta` ADD CONSTRAINT `detalle_venta_ibfk_3` FOREIGN KEY (`id_carrito`) REFERENCES `carrito`(`id_carrito`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `detalle_venta` ADD CONSTRAINT `detalle_venta_ibfk_4` FOREIGN KEY (`id_login`) REFERENCES `login`(`id_login`) ON DELETE NO ACTION ON UPDATE NO ACTION;
