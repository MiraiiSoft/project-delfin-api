...
import { authenticationJWT, cleanerRequest, validationVenta } from "../middlewares/index.js";

const router = Router();

router.get( '/', getAllVentas );
router.get( '/:ventaID', [ validationVenta.noExistId ], getOneVenta );
router.get( '/login/get', [ authenticationJWT.tokenValidation ], getOneVentaByLogin );
